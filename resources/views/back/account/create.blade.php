...
@section('page_title')
	New Account
	<span>
		<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/dashboard')}}">Dashboard</a> / <a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/account')}}">Account</a> / <span>New Account</span>
	</span>
@endsection
	...
	<div class="page-group">
		<div class="page-item col-1">
			<div class="page-item-content">
				...
				{!!Form::open(['url' => URL::to(Crypt::decrypt($setting->admin_url) . '/account'), 'files' => true])!!}
					<div class="page-group">
						<div class="page-item col-1">
