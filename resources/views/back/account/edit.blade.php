	...
	<script type="text/javascript">
		$(function(){
			$('.edit-form-image-delete').click(function(){
		    	...
		    	$.ajax({
		    		type: 'GET',
		    		url: "{{URL::to(Crypt::decrypt($setting->admin_url) . '/account/delete-image')}}/"+value,
...
@section('page_title')
	Account Edit
	<span>
		<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/dashboard')}}">Dashboard</a> / <a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/account')}}">Account</a> / <span>Account Edit</span>
	</span>
@endsection
...
@section('help')
	<ul class="menu-help-list-container">
		<li>
			Account dijadikan sebagai data di laporan pendapatan/beban diluar usaha
		</li>
	</ul>
@endsection
	...
	<div class="page-group">
		<div class="page-item col-1">
			<div class="page-item-content">
				...
				@else
					<a class="edit-button-item edit-button-back" href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/account')}}">
						Back
					</a>
				@endif
				...
				{!!Form::model($account, ['url' => URL::to(Crypt::decrypt($setting->admin_url) . '/account/' . $account->id), 'method' => 'PUT', 'files' => true])!!}
					<div class="page-group">
						<div class="page-item col-1">
							...
							<div class="page-item-content edit-item-content">
								...
								<div class="edit-form-group">
									...
									{!!Form::select('type', [''=>'Select Type', 'Income'=>'Income', 'Expense'=>'Expense', 'Other Income'=>'Other Income', 'Other Expense'=>'Other Expense'], null, ['class'=>'edit-form-text large select'])!!}
								</div>
								<div class="edit-form-group">
