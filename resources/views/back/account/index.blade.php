...
@section('page_title')
	Account
	<span>
		<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/dashboard')}}">Dashboard</a> / <span>Account</span>
	</span>
@endsection
...
@section('help')
	<ul class="menu-help-list-container">
		...
		<li>
			Gunakan tombol View di dalam tombol Action untuk melihat detail dari Account
		</li>
		<li>
			Gunakan tombol Edit di dalam tombol Action untuk mengedit Account
		</li>
		<li>
			Gunakan tombol Delete di dalam tombol Action untuk menghapus Account
		</li>
	</ul>
@endsection
	...
	{!!Form::open(['URL' => URL::current(), 'method' => 'GET'])!!}
		<div class="menu-group">
			...
			<div class="menu-search-group">
				...
				{!!Form::select('src_type', [''=>'Select Type', 'Income' => 'Income', 'Expense' => 'Expense', 'Other Income' => 'Other Income', 'Other Expense' => 'Other Expense'], null, ['class'=>'menu-search-text select'])!!}
			</div>
			<div class="menu-search-group">
		...
		<div class="page-item col-1">
			<div class="page-item-content">
				<div class="index-desc-container">
					<a class="index-desc-item" href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/account/create')}}">
				...
				<table class="index-table">
					...
					@foreach ($accounts as $account)
						...
						<tr>
							...
							<td>
								{!!$account->is_active == true ? "<span class='text-green'>Active</span>":"<span class='text-red'>Not Active</span>"!!}
							</td>
							<td class="index-td-icon">
								<div class="index-action-switch">
									...
									<ul class="index-action-child-container" style="width: 110px">
										<li>
											<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/account/' . $account->id)}}">
										...
										<li>
											<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/account/' . $account->id . '/edit')}}">
									...
									<div class="index-del-content">
										...
										{!!Form::open(['url' => URL::to(Crypt::decrypt($setting->admin_url) . '/account/' . $account->id), 'method' => 'DELETE', 'class'=>'form index-del-item'])!!}
				...
				{{-- 
					Pagination
				 --}}
				{{$accounts->appends($criteria)->links()}}
			</div>
		</div>
	</div>
@endsection