...
@section('page_title')
	New Stock Adjustment
	<span>
		<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/dashboard')}}">Dashboard</a> / <a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/adjustment')}}">Stock Adjustment</a> / <span>New Stock Adjustment</span>
	</span>
@endsection
...
@section('help')
	<ul class="menu-help-list-container">
		<li>
			Stock Adjustment digunakan untuk membuat stok masuk dan juga keluar (selain dari transaction front end)
		</li>
	</ul>
@endsection
	...
	<div class="page-group">
		<div class="page-item col-1">
			<div class="page-item-content">
				...
				{!!Form::open(['url' => URL::to(Crypt::decrypt($setting->admin_url) . '/adjustment'), 'files' => true])!!}
					<div class="page-group">
						<div class="page-item col-1">
							...
							<div class="page-item-content edit-item-content">
								<div class="edit-form-group">
									<?php
										...
										{
											$no_nota = 'ADJ/' . date('ymd') . '/1001';
										}
										else
										{
											$no_nota = 'ADJ/' . date('ymd') . '/' . ($lastadjustment->id + 1001);
										}
									?>

									{!!Form::label('nota', 'No. Nota', ['class'=>'edit-form-label'])!!}
									{!!Form::text('nota', $no_nota, ['class'=>'edit-form-text large', 'readonly', 'style="padding: 0px; border: 0px !important; background: transparent; font-size: 20px;'])!!}
									{!!Form::hidden('nota', $no_nota)!!}
								</div>
								<div class="edit-form-group">
									{!!Form::label('product', 'Product', ['class'=>'edit-form-label'])!!}
									{!!Form::select('product', $product_options, null, ['class'=>'edit-form-text product-select select large'])!!}
