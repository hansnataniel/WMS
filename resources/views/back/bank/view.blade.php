	...
	<div class="page-group">
		<div class="page-item col-1">
			<div class="page-item-content">
				...
				@if (file_exists(public_path() . '/usr/img/bank/' . $bank->id . '_' . Str::slug($bank->title, '_') . '_thumb.jpg'))
					{!!HTML::image('usr/img/bank/' . $bank->id . '_' . Str::slug($bank->title, '_') . '_thumb.jpg?lastmod=' . Str::random(5), '', ['class'=>'view-photo'])!!}
				@endif
				<div class="page-group">
					<div class="page-item col-1">
				...
				<div class="view-last-edit">
					<?php
						$createuser = Admin::find($bank->create_id);
						$updateuser = Admin::find($bank->update_id);
					?>
