...
@section('page_title')
	Other Expend / Revenue Report
	<span>
		<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/dashboard')}}">Dashboard</a> / <span>Other Expend / Revenue Report</span>
	</span>
@endsection
...
@section('help')
	<ul class="menu-help-list-container">
		<li>
			Masukkan Date Start dan Date End untuk melihat Other Expend / Revenue Report
		</li>
	</ul>
@endsection
	...
	<div class="page-group">
		<div class="page-item col-1">
			<div class="page-item-content">
				...
				{!!Form::open(['url' => URL::to(Crypt::decrypt($setting->admin_url) . '/other-expense-revenue/report'), 'files' => true])!!}
					<div class="page-group">
						<div class="page-item col-1">
