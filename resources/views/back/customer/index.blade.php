...
@section('page_title')
	Customer
	<span>
		<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/dashboard')}}">Dashboard</a> / <span>Customer</span>
	</span>
@endsection
...
@section('help')
	<ul class="menu-help-list-container">
		...
		<li>
			Gunakan tombol View di dalam tombol Action untuk melihat detail dari Customer
		</li>
		<li>
			Gunakan tombol Edit di dalam tombol Action untuk mengedit Customer
		</li>
		<li>
			Gunakan tombol Delete di dalam tombol Action untuk menghapus Customer
		</li>
	</ul>
@endsection
...
@section('search')
	{!!Form::open(['URL' => URL::current(), 'method' => 'GET'])!!}
		<div class="menu-group">
			...
			<div class="menu-search-group">
				{!!Form::label('src_phone', 'Phone', ['class'=>'menu-search-label'])!!}	
				{!!Form::text('src_phone', '', ['class'=>'menu-search-text'])!!}
			</div>
			<div class="menu-search-group">
				{!!Form::label('src_mobile', 'Mobile', ['class'=>'menu-search-label'])!!}	
				{!!Form::text('src_mobile', '', ['class'=>'menu-search-text'])!!}
			</div>
			<div class="menu-search-group">
		...
		<div class="page-item col-1">
			<div class="page-item-content">
				<div class="index-desc-container">
					<a class="index-desc-item" href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/customer/create')}}">
				...
				<table class="index-table">
					...
					@foreach ($customers as $customer)
						...
						<tr>
							...
							<td>
								{!!$customer->is_active == true ? "<span class='text-green'>Active</span>":"<span class='text-red'>Not Active</span>"!!}
							</td>
							<td class="index-td-icon">
								<div class="index-action-switch">
									...
									<ul class="index-action-child-container" style="width: 110px">
										<li>
											<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/customer/' . $customer->id)}}">
										...
										<li>
											<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/customer/' . $customer->id . '/edit')}}">
									...
									<div class="index-del-content">
										...
										{!!Form::open(['url' => URL::to(Crypt::decrypt($setting->admin_url) . '/customer/' . $customer->id), 'method' => 'DELETE', 'class'=>'form index-del-item'])!!}
