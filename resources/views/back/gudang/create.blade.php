...
@section('page_title')
	New Gudang
	<span>
		<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/dashboard')}}">Dashboard</a> / <a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/gudang')}}">Gudang</a> / <span>New Gudang</span>
	</span>
@endsection
	...
	<div class="page-group">
		<div class="page-item col-1">
			<div class="page-item-content">
				...
				{!!Form::open(['url' => URL::to(Crypt::decrypt($setting->admin_url) . '/gudang'), 'files' => true])!!}
					<div class="page-group">
						<div class="page-item col-1">
