...
@section('page_title')
	New Kendaraan
	<span>
		<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/dashboard')}}">Dashboard</a> / <a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/kendaraan')}}">Kendaraan</a> / <span>New Kendaraan</span>
	</span>
@endsection
	...
	<div class="page-group">
		<div class="page-item col-1">
			<div class="page-item-content">
				...
				{!!Form::open(['url' => URL::to(Crypt::decrypt($setting->admin_url) . '/kendaraan'), 'files' => true])!!}
					<div class="page-group">
						<div class="page-item col-1">
							...
							<div class="page-item-content edit-item-content">
								<div class="edit-form-group">
									...
									{!!Form::text('brand', null, ['class'=>'edit-form-text large', 'required', 'autofocus'])!!}
								...
								<div class="edit-form-group">
									...
									{!!Form::input('number', 'th_start', null, ['class'=>'edit-form-text large', 'required'])!!}
									<span class="edit-form-note">
										*Required
									</span>
								</div>
								<div class="edit-form-group">
									...
									{!!Form::input('number', 'th_end', null, ['class'=>'edit-form-text large', 'required'])!!}
									<span class="edit-form-note">
										*Required
									</span>
								</div>
								...
								<div class="edit-form-group">
									...
									{!!Form::input('number', 'cc', null, ['class'=>'edit-form-text large', 'required'])!!}
									<span class="edit-form-note">
										*Required
									</span>
								</div>
