...
@section('page_title')
	Substitution for {{$product->name}}
	<span>
		<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/dashboard')}}">Dashboard</a> / <span>Substitution for {{$product->name}}</span>
	</span>
@endsection
...
@section('help')
	<ul class="menu-help-list-container">
		...
		<li>
			Gunakan tombol View di dalam tombol Action untuk melihat detail dari Substitution
		</li>
		<li>
			Gunakan tombol Edit di dalam tombol Action untuk mengedit Substitution
		</li>
		<li>
			Gunakan tombol Delete di dalam tombol Action untuk menghapus Substitution
		</li>
	</ul>
@endsection
		...
		<div class="page-item col-1">
			<div class="page-item-content">
				<div class="index-desc-container">
					...
					<a class="index-desc-item" href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/product/add-substitution/' . $product->id)}}">
							...
							<td class="index-td-icon">
								<div class="index-action-switch">
									...
									<ul class="index-action-child-container" style="width: 110px">
										<li>
											<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/product/view-substitution/' . $substitution->id)}}">
										...
										<li>
											<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/product/edit-substitution/' . $substitution->id)}}">
									...
									<div class="index-del-content">
										<div class="index-del-title index-del-item">
											Do you really want to delete this substitution?
										</div>
										...
										{!!Form::open(['url' => URL::to(Crypt::decrypt($setting->admin_url) . '/product/delete-substitution/' . $substitution->id), 'method' => 'POST', 'class'=>'form index-del-item'])!!}
