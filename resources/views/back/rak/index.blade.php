...
@section('page_title')
	Rak
	<span>
		<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/dashboard')}}">Dashboard</a> / <span>Rak</span>
	</span>
@endsection
...
@section('help')
	<ul class="menu-help-list-container">
		...
		<li>
			Gunakan tombol View di dalam tombol Action untuk melihat detail dari Rak
		</li>
		<li>
			Gunakan tombol Edit di dalam tombol Action untuk mengedit Rak
		</li>
		<li>
			Gunakan tombol Delete di dalam tombol Action untuk menghapus Rak
		</li>
	</ul>
@endsection
...
@section('search')
	{!!Form::open(['URL' => URL::current(), 'method' => 'GET'])!!}
		<div class="menu-group">
			...
			<div class="menu-search-group">
				{!!Form::label('src_code_id', 'Barcode', ['class'=>'menu-search-label'])!!}	
				{!!Form::text('src_code_id', '', ['class'=>'menu-search-text'])!!}
			</div>
			<div class="menu-search-group">
				{!!Form::label('src_gudang_id', 'Gudang', ['class'=>'menu-search-label'])!!}	
				{!!Form::select('src_gudang_id', $gudang_options, null, ['class'=>'menu-search-text select'])!!}
			</div>
			<div class="menu-search-group">
		...
		<div class="page-item col-1">
			<div class="page-item-content">
				<div class="index-desc-container">
					<a class="index-desc-item" href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/rak/create')}}">
				...
				<table class="index-table">
					...
					@foreach ($raks as $rak)
						...
						<tr>
							...
							<td>
								{!!$rak->is_active == true ? "<span class='text-green'>Active</span>":"<span class='text-red'>Not Active</span>"!!}
							</td>
							<td class="index-td-icon">
								<div class="index-action-switch">
									...
									<ul class="index-action-child-container" style="width: 110px">
										<li>
											<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/rak/' . $rak->id)}}">
										...
										<li>
											<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/rak/' . $rak->id . '/edit')}}">
									...
									<div class="index-del-content">
										<div class="index-del-title index-del-item">
											Do you really want to delete this rak?
										</div>
										...
										{!!Form::open(['url' => URL::to(Crypt::decrypt($setting->admin_url) . '/rak/' . $rak->id), 'method' => 'DELETE', 'class'=>'form index-del-item'])!!}
