...
@section('page_title')
	New Return
	<span>
		<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/dashboard')}}">Dashboard</a> / <a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/return')}}">Return</a> / <span>New Return</span>
	</span>
@endsection
	...
	<div class="page-group">
		<div class="page-item col-1">
			<div class="page-item-content">
				...
				{!!Form::open(['url' => URL::to(Crypt::decrypt($setting->admin_url) . '/return'), 'files' => true])!!}
					<div class="page-group">
						<div class="page-item col-1">
							...
							<div class="page-item-content edit-item-content">
								<div class="edit-form-group">
									<?php
										$lastpo = Retur::orderBy('id', 'desc')->first();
										if($lastpo == null)
										{
											$no_nota = 'RET/' . date('ymd') . '/1001';
										}
										else
										{
											$no_nota = 'RET/' . date('ymd') . '/' . ($lastpo->id + 1001);
										}
									?>
								...
								<div class="supplier-result" style="margin-bottom: 15px;">
									<div class="edit-form-group">
										{!!Form::label('receive_item', 'Receive Item', ['class'=>'edit-form-label'])!!}
										{!!Form::select('receive_item', [''=>'Select Supplier First'], null, ['class'=>'edit-form-text ri-select select large'])!!}
										<span class="edit-form-note">
											*Required
										</span>
									</div>
