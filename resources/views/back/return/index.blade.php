...
@section('page_title')
	Return
	<span>
		<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/dashboard')}}">Dashboard</a> / <span>Return</span>
	</span>
@endsection
...
@section('help')
	<ul class="menu-help-list-container">
		...
		<li>
			Gunakan tombol View di dalam tombol Action untuk melihat detail dari Return
		</li>
		<li>
			Gunakan tombol Edit di dalam tombol Action untuk mengedit Return
		</li>
		<li>
			Gunakan tombol Delete di dalam tombol Action untuk menghapus Return
		</li>
	</ul>
@endsection
		...
		<div class="page-item col-1">
			<div class="page-item-content">
				<div class="index-desc-container">
					<a class="index-desc-item" href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/return/create')}}">
							...
							<td class="index-td-icon">
								<div class="index-action-switch">
									...
									<ul class="index-action-child-container" style="width: 110px">
										<li>
											<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/return/print/' . $return->id)}}" class="separator printed">
										...
										<li>
											<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/return/' . $return->id)}}">
										...
										<li>
											<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/return/' . $return->id . '/edit')}}">
									...
									<div class="index-del-content">
										...
										{!!Form::open(['url' => URL::to(Crypt::decrypt($setting->admin_url) . '/return/' . $return->id), 'method' => 'DELETE', 'class'=>'form index-del-item'])!!}
				...
				{{-- 
					Pagination
				 --}}
				{{$returns->appends($criteria)->links()}}
			</div>
		</div>
	</div>
