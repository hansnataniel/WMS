...
@section('page_title')
	Recieve Item
	<span>
		<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/dashboard')}}">Dashboard</a> / <span>Recieve Item</span>
	</span>
@endsection
		...
		<div class="page-item col-1">
			<div class="page-item-content">
				<div class="index-desc-container">
					<a class="index-desc-item" href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/ri/create')}}">
							...
							<td class="index-td-icon">
								<div class="index-action-switch">
									...
									<ul class="index-action-child-container" style="width: 110px">
										<li>
											<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/ri/print/' . $ri->id)}}" class="separator printed">
										...
										<li>
											<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/ri/' . $ri->id)}}">
										...
										<li>
											<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/ri/' . $ri->id . '/edit')}}">
									...
									<div class="index-del-content">
										<div class="index-del-title index-del-item">
											Do you really want to delete this Recieve Item?
										</div>
										...
										{!!Form::open(['url' => URL::to(Crypt::decrypt($setting->admin_url) . '/ri/' . $ri->id), 'method' => 'DELETE', 'class'=>'form index-del-item'])!!}
