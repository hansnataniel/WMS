...
@section('page_title')
	Supplier
	<span>
		<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/dashboard')}}">Dashboard</a> / <span>Supplier</span>
	</span>
@endsection
...
@section('help')
	<ul class="menu-help-list-container">
		...
		<li>
			Gunakan tombol View di dalam tombol Action untuk melihat detail dari Supplier
		</li>
		<li>
			Gunakan tombol Edit di dalam tombol Action untuk mengedit Supplier
		</li>
		<li>
			Gunakan tombol Delete di dalam tombol Action untuk menghapus Supplier
		</li>
	</ul>
@endsection
		...
		<div class="page-item col-1">
			<div class="page-item-content">
				<div class="index-desc-container">
					<a class="index-desc-item" href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/supplier/create')}}">
				...
				<table class="index-table">
					...
					@foreach ($suppliers as $supplier)
						...
						<tr>
							...
							<td>
								{!!$supplier->is_active == true ? "<span class='text-green'>Active</span>":"<span class='text-red'>Not Active</span>"!!}
							</td>
							<td class="index-td-icon">
								<div class="index-action-switch">
									...
									<ul class="index-action-child-container" style="width: 110px">
										<li>
											<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/supplier/' . $supplier->id)}}">
										...
										<li>
											<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/supplier/' . $supplier->id . '/edit')}}">
									...
									<div class="index-del-content">
										...
										{!!Form::open(['url' => URL::to(Crypt::decrypt($setting->admin_url) . '/supplier/' . $supplier->id), 'method' => 'DELETE', 'class'=>'form index-del-item'])!!}
				...
				{{-- 
					Pagination
				 --}}
				{{$suppliers->appends($criteria)->links()}}
			</div>
		</div>
	</div>
@endsection