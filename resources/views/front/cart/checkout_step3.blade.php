...
@section('content')
    <section class="checkout">
        ...
        <div class="checkout-header">
            ...
            <span class="checkout-active">STEP 3: PAYMENT CONFIRMATION</span>
        </div>
        <div class="checkout-payment-confirmation">
            ...
            <span>
                ...
                konfirmasi pembayaran Anda disini agar dapat memproses secepatnya. 
            </span>
            @if(count($errors) != 0)
                <br><br>
            ...
            @endif
            {{Form::open(array('url'=>URL::to('checkout/step3/' . $transaction_url), 'method'=>'POST', 'files'=>true, 'class'=>'checkout-payment-form'))}}
