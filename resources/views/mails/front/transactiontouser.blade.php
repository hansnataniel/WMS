		...
		<table id="wrapper" style="font-size: 14px; color: #0d0f3b; font-family: arial; width: 100%; line-height: 20px;">
			...
			<tr>
				<td id="section-container" style="padding: 20px;">
					...
					<p>
		                Terima kasih telah berbelanja di {{$setting->name}}. <br>
		                Setelah melakukan pembayaran melalui Bank Transfer, segera lakukan konfirmasi pembayaran <a href="{{URL::to('payment-confirmation/pay/' . $transaction->no_nota)}}" target="_blank" style="color: #FDD000; text-decoration: none">disini.</a> agar kami dapat memproses pesanan Anda secepatnya.<br><br>
		                
		                Pembayaran dapat Anda lakukan secara transfer ke rekening bank kami:
		            </p>
